...
#ifndef __TmYouAi__CCXMLParser__
#define __TmYouAi__CCXMLParser__
...
class CCXMLParser: public cocos2d::CCObject, public cocos2d::CCSAXDelegator
{
public:
...
#endif /* defined(__TmYouAi__CCXMLParser__) */
